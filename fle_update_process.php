...
$sql = "UPDATE car_mart_ticket_new SET PONumber = '$PO', InvoiceNumber = '$Invoice',date_updated = '$today',`status` = 'invoiced' WHERE Ticket = '$Ticket'";
$result = mysqli_query($conn,$sql) or die(mysqli_error($conn));

$content = 'PO Invoiced.<br><br>Ticket Updated.<br><br>';
