...
$title ='New Quote';
$content = '
<form method="post" action="quote_process.php" >
...
<div class="col-sm-10">
  ...
  <select class="form-select" aria-label="Warranty Part" name="warranty">
  <option selected value="N">No Warranty</option>
  <option value="Y">Warranty Part</option>
</select>
